...
export default function ForkliftHero({ page }) {
  ...
  return (
    <section className="forklift-hero overflow-hidden bg-primary text-white lg:min-h-0">
      <div className="mx-auto grid max-w-[1440px] gap-8 px-6 py-10 md:px-12 md:py-14 lg:grid-cols-[minmax(0,0.72fr)_minmax(0,1.28fr)] lg:items-stretch lg:gap-10 lg:py-8 xl:gap-14">
