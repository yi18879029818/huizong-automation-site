  ...
  return (
    <footer className="hsa-footer">
      <div className="hsa-footer-inner">
        <div className="hsa-footer-column hsa-footer-column--brand">
          ...
          <div className="hsa-footer-contact">
            <NavLink className="hsa-footer-contact-link" href="mailto:sales@robotlyne.com" aria-label="Email">
            ...
            <NavLink
              ...
              target="_blank"
            >
              <span className="hsa-footer-contact-icon-svg" aria-hidden="true">
            ...
            <NavLink className="hsa-footer-contact-link" href="tel:8613510816743" aria-label="Phone">
        ...
        {NAV_SECTIONS.map((section) => (
          <div
            className={`hsa-footer-column hsa-footer-column--${section.key}`}
            key={section.key}
          >
            <h4>{section.label}</h4>
        ...
        <div className="hsa-footer-column hsa-footer-column--resources">
          <h4>Resources</h4>
          <div className="hsa-footer-links">
            <NavLink href="/blog">Blog</NavLink>
            <NavLink href="/faq">FAQ</NavLink>
        ...
        <div className="hsa-footer-signup">
          ...
          <p className="hsa-footer-signup-copy">
            Get monthly updates on warehouse automation systems, software releases,
          ...
          >
            <label className="hsa-news-label" htmlFor="hsa-news-email">Email</label>
            <input
              id="hsa-news-email"
              className="hsa-news-input"
              type="email"
              name="email"
              placeholder="Email"
              required
            ...
            <button className="hsa-news-submit" type="submit">Subscription</button>
          </form>
          <div className="hsa-social">
            ...
            <div className="hsa-social-links">
              <NavLink
                ...
                target="_blank"
              >
                <span className="hsa-social-icon" aria-hidden="true">
