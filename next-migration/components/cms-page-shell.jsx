      ...
      <div className="hsa-footer-inner">
        <div className="hsa-footer-column hsa-footer-column--brand">
          ...
          <div className="hsa-footer-contact">
            <Link className="hsa-footer-contact-link" href="mailto:sales@robotlyne.com" aria-label="Email">
            ...
            <Link className="hsa-footer-contact-link" href="tel:8613510816743" aria-label="Phone">
        ...
        {NAV_SECTIONS.map((section) => (
          <div className={`hsa-footer-column hsa-footer-column--${section.key}`} key={section.key}>
            <h4>{section.label}</h4>
        ...
        <div className="hsa-footer-signup">
          ...
          >
            <label className="hsa-news-label" htmlFor="cms-news-email">Email</label>
            <input
              id="cms-news-email"
